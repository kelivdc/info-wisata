                  ...
                  >
                    ...
                    <FormControl isInvalid={formik.errors.sort && formik.touched.sort} isRequired>
                      <Flex justifyContent={"space-between"}>
                        ...
                        <Box w="70%">
                          <Field as={Input} type="number" name="sort"/>    
                          <FormErrorMessage>{formik.errors.sort}</FormErrorMessage>
                        </Box>
                      </Flex>      
                    </FormControl>    
                    <FormControl isInvalid={formik.errors.publish && formik.touched.publish}>
                      <Flex>
                    ...
                    <Flex justifyContent={"flex-end"} mt={8} gap={2}>
                      <Button colorScheme={"gray"} size="sm" onClick={modal_name.onClose}>Cancel</Button>
                      <Button colorScheme={"green"} size="sm" type="submit">Save</Button>
                    </Flex>             
                  </SimpleGrid>
                )}
            </Formik>
